...
public class Client {
  ...
  static final int RCV_RATE = 2; //for receiving loop
  int jitterBufferSize = 50; // start delay
  ...
  class setupButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (state == INIT) {
        ...
        try {
          // TASK DONE construct a new DatagramSocket to receive server RTP packets on port
          // RTP_RCV_PORT
  ...
  class timerPlayListener implements ActionListener {
    ...
    // TASK DONE complete the statistics
